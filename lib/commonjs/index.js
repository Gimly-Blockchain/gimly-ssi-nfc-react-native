...
class NfcSdk {
  ...
  static async signCredential(signCredentialRequest, keyId) {
    ...
    const signedCredential = _signing.default.credential(signCredentialRequest.credential, keyId || NfcSdk.keyId);
  ...
  static async signPresentation(signPresentationRequest, keyId) {
    ...
    const signedPresentation = _signing.default.presentation(signPresentationRequest.presentation, keyId || NfcSdk.keyId);
