...
export default class NfcSdk {
  ...
  static async createKey(cardId, curve) {
    ...
    const data = await TangemSdk.createWallet(ellipticCurve, cardId); // data = {"cardId":"AC79000000000004","wallet":{"totalSignedHashes":0,"index":8,"hasBackup":false,"derivedKeys":[],"curve":"secp256k1","publicKey":"037C58B433A9063575C12232A0763DCC09423C8180E977AE9F8C527F462DBC4B5C","chainCode":"CB2C5D06D739E6D42321A8E456B3DF2E70308ECE75DF6EAE830D4D0B2B3F887B","settings":{"isPermanent":false}}}
