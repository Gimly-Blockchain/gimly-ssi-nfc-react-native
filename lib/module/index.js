...
export default class NfcSdk {
  ...
  static async createKey(cardId, curve) {
    ...
    const data = await TangemSdk.createWallet(curve, cardId); // data = {"cardId":"AC79000000000004","wallet":{"totalSignedHashes":0,"index":8,"hasBackup":false,"derivedKeys":[],"curve":"secp256k1","publicKey":"037C58B433A9063575C12232A0763DCC09423C8180E977AE9F8C527F462DBC4B5C","chainCode":"CB2C5D06D739E6D42321A8E456B3DF2E70308ECE75DF6EAE830D4D0B2B3F887B","settings":{"isPermanent":false}}}
  ...
  static async deactivateKey(cardId, keyId) {
    ...
    const data = await TangemSdk.purgeWallet(keyId, cardId); // data = {cardId: 'AC79000000000004'}
  ...
  static async signUsingKey(keyId, signRequest, cardId) {
    ...
    const data = await TangemSdk.signHashes(hashes, keyId, cardId); // data = {"totalSignedHashes":12,"cardId":"AC79000000000004","signatures":["64B4BB5428A78605E2E1AD9FE1F7CDFE336094C8F1A2D0583D16C6591CACCB7775E142B0B32D8DC19868892DC9EB2EC50CE8657C24AB79A97B45A535A6455958","86F2980929F858170F89D39F9E3D07D8ABEC6F5FFAD9692D2FBF4725C95F091C14EEF455BC559F2BB76ECC9BCB6E90CB93C305D7D4ABAE3195D0463B6D5E9182"]}
  ...
  static async signCredential(keyId, signCredentialRequest, cardId) {
    ...
    try {
      const requestResponse = await TangemSdk.writeOwnerFile(files, keyId, cardId); // TODO: check response to convert to desired format response
  ...
  static async deleteStoredCredential(credentialId, cardId) {
    ...
    return await TangemSdk.deleteFiles(indicesToDelete, cardId).then(response => {
      return response;
    }).catch(() => {
      return null;
    });
